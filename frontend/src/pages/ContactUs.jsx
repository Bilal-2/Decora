    ...
    <div>
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1">University of Engineering and Tecnonolgy Lahore, New Campus</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                <a href="mailto:example@email.com" className="text-[#6f3914] leading-relaxed">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-transparent p-4 rounded-xl shadow-xl hover:shadow-inner flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
