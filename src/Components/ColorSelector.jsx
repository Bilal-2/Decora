...
const CheckMark = () => (
    <svg className="bg-transparent"  stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="flex gap-2">
        {
            colors.map((color, i) => (
                ...
                {
                    index === i &&
                    <CheckMark className="bg-transparent"/>
                }
                </button>
            ))
        }
