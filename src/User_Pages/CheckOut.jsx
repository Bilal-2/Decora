          ...
          <div className="max-w-lg mx-auto lg:max-w-none">
            ...
            <ul role="list" className="text-sm font-medium text-gray-900 divide-y divide-gray-200">
              {cartItems.map((cartItem) => (
                <li key={cartItem.id} className="flex items-start py-6 space-x-4">
                  <img
                    src={cartItem.image}
                    alt={cartItem.name}
                  ...
                  <div className="flex-auto space-y-1">
                    <h3 className='capitalize'>{cartItem.name}</h3>
                    {/* <p className="text-gray-500">{cartItems.color}</p>
                    <p className="text-gray-500">{cartItems.size}</p> */}
                  </div>
                  <p className="flex-none text-base font-medium">Rs {cartItem.price}</p>
                </li>
              ))}
            </ul>
            ...
            <dl className="hidden text-sm font-medium text-gray-900 space-y-6 border-t border-gray-200 pt-6 lg:block">
              ...
              <div className="flex items-center justify-between">
                ...
                <dd>Rs {totalPrice* 0.2}</dd>
              </div>

              <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                <dt className="text-base">Total</dt>
                <dd className="text-base">Rs {totalPrice+(totalPrice*0.2)+ 300}</dd>
              </div>
            </dl>
              ...
              <div className="relative z-10 bg-white border-t border-gray-200 px-4 sm:px-6">
                <div className="max-w-lg mx-auto">
                  <Popover.Button className="w-full flex items-center py-6 font-medium">
                    ...
                    <span className="text-base mr-2">Rs {totalPrice+(totalPrice*0.2)+ 300}</span>
        ...
        <form className="pt-16 pb-36 px-4 sm:px-6 lg:pb-16 lg:px-0 lg:row-start-1 lg:col-start-1">
          <div className="max-w-lg mx-auto lg:max-w-none">
            <section aria-labelledby="contact-info-heading">
              ...
              <div className="mt-6">
                <label htmlFor="email-address" inputMode='' className="block text-sm font-medium text-gray-700">
                  Email address
                </label>
                <div className="mt-1">
                  <input
