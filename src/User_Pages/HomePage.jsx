        ...
        <div className='mt-4 col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-1'>
          <div className='relative'>
            ...
            <div className='absolute bottom-0 left-0 text-white font-bold text-xl bg-transparent p-9  w-full h-full place-content-center '>
              ...
              <h2 className='bg-transparent text-center text-2xl sm:text-2xl md:text-3xl lg:text-4xl  my-7'>SOFA STYLE <br /> 2020</h2>

              <div className='w-full bg-transparent flex justify-center'>

                <button className={"   px-7 py-3 bg-btncolor1  text-[1.12rem] transform hover:bg-btncolor2   rounded-xl "}>
                  Shop Now
                </button>
              </div>
      ...
      <div className='p-4 lg:p-8 gap-4 lg:gap-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 h-auto relative'>
        ...
        <div className='mt-4 col-span-1 sm:col-span-2 md:col-span-1 lg:col-span-2 flex items-center justify-center relative'>
          <div className='h-[23.7rem] w-full rounded-2xl overflow-hidden bg-orange-500'>
            <img src={img6} alt='' className='-translate-y-[50%] w-full object-cover object-bottom bg-orange-500 ' />
          </div>
          <div className='absolute bottom-0 left-0 text-white font-bold text-xl bg-transparent p-9  w-full h-full place-content-center '>
            <div className='relative bg-transparent border-4 rounded-xl h-full w-full p-8'>
              ...
              <h2 className='bg-transparent text-center text-2xl sm:text-3xl md:text-4xl lg:text-4xl mt-3 mb-3'>HOME <br /> OFFICE</h2>

              <div className='w-full bg-transparent flex justify-center'>

                <button className={"   px-7 py-3 bg-btncolor3 text-black text-[1.12rem] transform hover:bg-btncolor2 hover:text-white  rounded-xl "}>
                  Shop Now
                </button>
              </div>
        ...
        <div className='mt-4 col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-2'>
          <div className='relative'>
            ...
            <div className='absolute bottom-0 left-0 text-white font-bold text-xl bg-transparent p-9  w-full h-full place-content-center '>
              ...
              <p className='bg-transparent text-center text-black  mt-6'>New Arrivals</p>
              <h2 className='bg-transparent text-center text-black text-2xl sm:text-2xl md:text-3xl lg:text-4xl  my-7'>PERFECT FIT FOR <br /> YOUR HOME</h2>
        ...
        <div className='mt-4 col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-1'>
          <div className='relative'>
            ...
            <div className='absolute bottom-0 left-0 text-white font-bold text-xl bg-transparent p-9  w-full h-full place-content-center '>
              ...
              <p className='bg-transparent text-center  mt-6'>New Arrivals</p>
              <h2 className='bg-transparent text-center text-2xl sm:text-2xl md:text-3xl lg:text-4xl  my-7'>SALE UPTO 30% <br /> OFF</h2>
