...
function SingleProduct() {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true)
      const response = await fetch(`https://decora-backend.vercel.app/api/SingleProduct/${_id}`).then(res => res.json()).catch(err => console.log(err)).finally(() => setLoading(false));
      setProduct(response);
    })();
  }, [_id])
          ...
          <>
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-1/2 md:pl-8 capitalize">
                <h1 className="text-xl md:text-3xl text-black">{name}</h1>
            ...
            <div className="mt-10">
              <h4 className="text-lg font-bold border-b mb-3 text-black">Description</h4>
